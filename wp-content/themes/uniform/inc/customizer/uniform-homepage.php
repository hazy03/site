...
/*--------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_control( new Uniform_Customize_Category_Control( 
        $wp_customize,
            'slider_category', 
            array(
                'label'         => __( "Slider's Category", 'uniform' ),
                'description'   => __( 'Select category for Homepage slider', 'uniform' ),
    ...
    $wp_customize->add_control( new Uniform_Customize_Switch_Control(
        $wp_customize, 
            ...
            array(
                ...
                'description'   => __( 'Show/Hide slider pager', 'uniform' ),
                'section'       => 'uniform_slider_section',
                'choices'       => array(
                    'show' => __( 'Show', 'uniform' ),
                    'hide' => __( 'Hide', 'uniform' ),
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'description'   => __( "Choose option about slide auto/manual transaction at homepage.", 'uniform' ),
            'section'       => 'uniform_slider_section',
            'choices'       => array(
...
/*-------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_control( new Uniform_Customize_Switch_Control(
        $wp_customize, 
            ...
            array(
                'type'          => 'switch',
                'priority'      => 2,
                'label'         => __( 'Section Control', 'uniform' ),
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'description'   => __( 'Add title for Service section.', 'uniform' ),
            'section'       => 'uniform_service_section',
            'priority'      => 3
        )
    );
    $wp_customize->selective_refresh->add_partial( 
        ...
        array(
            ...
            'render_callback'   => 'uniform_customize_partial_service_title',
        )
    );
    ...
    $wp_customize->add_control( new Uniform_Customize_Category_Control( 
        $wp_customize,
            ...
            array(
                ...
                'description'   => __( "Select category for Homepage's Service section", "uniform" ),
                'section'       => 'uniform_service_section',
                'priority'      => 4
            )
        )
...
/*--------------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_section(
        ...
        array(
            'title'         => __( 'About/Testimonials', 'uniform' ),
            'priority'      => 6,
            'panel'         => 'uniform_homepage_panel'
        )
    );
    ...
    $wp_customize->add_control( new Uniform_Customize_Switch_Control(
        $wp_customize, 
            ...
            array(
                ...
                'priority'      => 2,
                'label'         => __( 'Section Control', 'uniform' ),
                'description'   => __( 'Enable/Disable option to display About/Testimonials section at home page.', 'uniform' ),
   ...
   $wp_customize->add_setting(
    ...
    $wp_customize->add_control( new Uniform_Section_Info( 
        $wp_customize,
        'about_section_info', 
            array(
                'type'          => 'section_info',
   ...
   $wp_customize->add_setting(
    ...
    $wp_customize->add_control( new Uniform_Section_Info( 
        $wp_customize,
            ...
            array(
                ...
                'description'   => __( 'Set the testimonials section.', 'uniform' ),
                'section'       => 'uniform_about_section',
                'priority'      => 6
            )
        )
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'description'   => __( 'Add title for testimonials section.', 'uniform' ),
            'section'       => 'uniform_about_section',
            'priority'      => 7
        )
    );
    $wp_customize->selective_refresh->add_partial( 
        'testimonials_section_title', 
            array(
                'selector'          => '#testi-section-title',
                'render_callback'   => 'uniform_customize_partial_testimonial_title',
            )
    );
    ...
    $wp_customize->add_control(  new Uniform_Customize_Category_Control( 
        $wp_customize,
            ...
            array(
                ...
                'description'   => __( 'Select category for testimonials posts.', 'uniform' ),
                'section'       => 'uniform_about_section',
                'priority'      => 8
            )
        )
...
/*-------------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_control(
        ...
        array(
            'type'          => 'text',
            'label'         => __( 'Section Title', 'uniform' ),
            'description'   => __( 'Add title for latest Blog section.', 'uniform' ),
            'section'       => 'uniform_latest_blog_section',
            'priority'      => 4
        )
    );
    $wp_customize->selective_refresh->add_partial( 
        ...
        array(
            ...
            'render_callback'   => 'uniform_customize_partial_blog_section_title',
        )
    );
    ...
    $wp_customize->add_control( new Uniform_Customize_Category_Control(
        $wp_customize,
            ...
            array(
                ...
                'description'   => __( 'Select category for latest Blog posts.', 'uniform' ),
                'section'       => 'uniform_latest_blog_section',
                'priority'      => 5
            )
        )
...
/*----------------------------------------------------------------------------------------------------------------*/
    ...
    $uniform_section_reorder_url = __( 'Section Re-order by using Drag and Drop is only available in pro version. Please visit ','uniform' ).': <a href="'.esc_url( 'https://mysterythemes.com/wp-themes/uniform-pro/' ).'" target="_blank">'.__( ' here', 'uniform' ).'</a>';
