<?php
/**
 * Sanitize all option in customizer
 * 
...
if ( ! function_exists( 'uniform_sanitize_select' ) ) :
     ...
     * @since 1.3.8
     */
    function uniform_sanitize_select( $input, $setting ) {
 ...
 *
 * @since Uniform 1.2.5
 * @see uniform_homepage_settings_register()
 *
 * @return void
 */
function uniform_customize_partial_service_title() {
 ...
 * @return void
 */
function uniform_customize_partial_testimonial_title() {
 ...
 * @return void
 */
function uniform_customize_partial_blog_section_title() {
    return get_theme_mod( 'latest_blog_title' );
}