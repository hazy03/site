 ...
 */
require get_template_directory() . '/inc/widgets/uniform-widget-fields.php'; // widget fields
require get_template_directory() . '/inc/widgets/uniform-cta.php';           // Call to Action widget